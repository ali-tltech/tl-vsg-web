...
export const HrFoundationDetails = {
  icon: "icon-global",
  text: "Laying the groundwork for a future-ready HR function",
  contents: [
...
export const TalentEdgeSolutionsDetails = {
  icon: "icon-global",
  text: "Attracting, Engaging & Retaining Top Talent",
  contents: [
...
export const LeadershipHorizonHubDetails = {
  icon: "icon-global",
  text: "Transforming Managers into Visionary Leaders",
  contents: [
    "Executive Coaching & Leadership Programs – Developing future-ready leaders with personalized guidance.",
    "'Ready for Next' Theatre-based Leadership Program – An immersive, experience-driven approach to equip leaders with the skills to navigate change and inspire innovation.",
    "Managerial Effectiveness Programs – Empowering managers to drive optimal team performance.",
    "Behavioural Training Modules – Enhancing communication, collaboration, and interpersonal skills.",
    "Succession Leadership Strategy – Building a robust pipeline of future leaders."
  ],
  conclusionText: ""
};
...
export const CulturalTransformationStudioDetails = {
  ...
  text: "",
  contents: [
    "Building Inclusive & Engaged Work Cultures",
    "Culture Building & DEI Initiatives – Fostering inclusive workplaces.",
    "Change Management & Organizational Development – Navigating transformation effectively.",
...
export const SmartHRSolutionsDetails = {
  icon: "icon-global",
  text: "Leveraging AI & Automation for HR Efficiency",
  contents: [
    "Compensation Benchmarking & Total Rewards Strategy – Optimizing pay structures for growth.",
    "AI-Driven HR Automation & Workforce Analytics – Enhancing decision-making through technology.",
    "Mergers & Acquisitions – HR Integration – Ensuring smooth transitions during business restructuring.",
    "On-Demand HR Leadership – Providing strategic HR leadership when and where it's needed, ensuring businesses have expert HR guidance without the overhead of a full-time team."
  ],
  conclusionText: ""
};
...
export const EmployeeEngagementCatalystDetails = {
  icon: "icon-global",
  text: "Building Scalable HR Operations for Global Growth",
  text2:     "We enable and support businesses in incubating HR Shared Services with a strong focus on optimizing economies of scale and building Centers of Excellence (CoE) in HR for clients with global operations.",
  contents: [
    "HR Shared Services Setup – Establishing centralized HR operations.",
    "Process Standardization & Optimization – Ensuring efficiency across HR functions.",
    "Technology Enablement – Leveraging automation and digital HR solutions.",
    "Governance & Risk Compliance – Managing legal and operational risks.",
    "BOT Model Execution – Implementing Build-Operate-Transfer (BOT) models, ensuring businesses can launch, stabilize, and eventually take full control of their HR Shared Services."
  ],
  conclusionText: ""
};
