  ...
  tabs: [
    {
      ...
      text: `
      VS GenX Solutions empowers businesses with purpose-driven, scalable HR solutions. Founded by Venkatesan Srinivasan, whose journey began in 2018, we've supported 10+ SMEs and 5+ startups in HR transformation. After a corporate stint as Global HR Head, Venkat returned to his mission building inclusive HR systems.
In just six months, we've impacted 50+ leaders, led AI-driven HR automation, and served as on-demand HR for 5+ SMEs, blending human insight with digital agility.
    `,
    }
,    
    // {
